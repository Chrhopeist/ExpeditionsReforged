...
namespace Expeditions
{
    ...
    public class Expeditions : Mod
    {
        ...
        internal static void SystemLoadContent()
        {
            ...
            {
                CurrencyTextColor = new Color(226, 51, 240),
                CurrencyTextKey = Items.BountyVoucher.itemName
            };
            currencyVoucherID = CustomCurrencyManager.RegisterCurrency(c);

            if (DEBUG)
            {
                AutoLoadExpeditions(ModContent.GetInstance<Expeditions>());
            }
        }

        internal static void SystemUnloadContent()
        {
            expeditionTemplateList = null;
            expeditionActiveList = null;
            checkedState = null;

            sortingTexture = null;
            bountyBoardTexture = null;

            expeditionUserInterface = null;
            expeditionUI = null;
        ...
        /// </summary>
        internal static void SetupExpeditionDefaults()
        {
        ...
        internal static void ModifyInterfaceLayersHook(List<GameInterfaceLayer> layers)
        {
            if (expeditionUserInterface == null || expeditionUI == null || trackerInterface == null || trackerUI == null)
            {
                return;
            }
        ...
        internal static void PostUpdateInputHook()
        {
    ...
    public class ExpeditionsSystem : ModSystem
    {
        ...
        {
            Expeditions.SystemLoadContent();
        }

        public override void OnModUnload()
        {
            Expeditions.SystemUnloadContent();
        }

        public override void AddRecipes()
        {
            Expeditions.SetupExpeditionDefaults();
        }
        ...
        public override void ModifyInterfaceLayers(List<GameInterfaceLayer> layers)
        {
            ...
            Expeditions.ModifyInterfaceLayersHook(layers);
        }
        ...
        public override void PostUpdatePlayers()
        {
            ...
            Expeditions.PostUpdateInputHook();
        }
    }
}
